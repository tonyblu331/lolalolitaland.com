...
export const galleryImages = [
  ...
  { image: GalleryImg2, alt: "Lola Lolita Land festival de música." },
  { image: GalleryImg3, alt: "Lla Índigo en un escenario en el festivas de Lola Lolita Land." },
  { image: GalleryImg5, alt: "Lola Lolita justo a un grupo de bailarines." },
  { image: GalleryImg6, alt: "Lola Lolita justo a un grupo de bailarines." },
  { image: GalleryImg7, alt: "Lola Lolita justo a un grupo de bailarines." },
  { image: GalleryImg8, alt: "Lola Lolita justo a un grupo de bailarines." },
  { image: GalleryImg9, alt: "Lola Lolita justo a un grupo de bailarines." },
  { image: GalleryImg10, alt: "Lola Lolita justo a un grupo de bailarines." },
  { image: GalleryImg11, alt: "Marina Reche en el evento de Lola Lolita Land." },
  { image: GalleryImg12, alt: "Marina Reche en el evento de Lola Lolita Land." },
  { image: GalleryImg13, alt: "Dj en el evento de Lola Lolita Land." },
  { image: GalleryImg14, alt: "Dj en el evento de Lola Lolita Land." },
  { image: GalleryImg15, alt: "Grupo de personas con tambores sobre un escenario." },
  { image: GalleryImg16, alt: "Grupo de personas con tambores sobre un escenario." },
  { image: GalleryImg17, alt: "Gente mirando hacia el escenario." },
  { image: GalleryImg18, alt: "Gente mirando hacia el escenario." },
  { image: GalleryImg19, alt: "Lola Lolita en un escenario cantanto." },
  { image: GalleryImg20, alt: "Lola Lolita en un escenario bailando." },
  {
    image: GalleryImg21,
    alt: "Lola Lolita en un escenario bailando junto y Abraham Mateo cantando.",
  },
  { image: GalleryImg22, alt: "2 personas lanzando regalos al público." },
  { image: GalleryImg23, alt: "Lola Lolita dandose un abrazo con sus fans." },
  { image: GalleryImg24, alt: "Dj" },
  { image: GalleryImg25, alt: "Gente de fiesta en el evento de Lola Lolita." },
  { image: GalleryImg26, alt: "Lola Lolita saliendo de una caja sorpresa." },
  { image: GalleryImg27, alt: "Gente sobre el escenario bailando y rapeando." },
  { image: GalleryImg28, alt: "Lola Lolita cantando, bailand justo a otras personas." },
  { image: GalleryImg29, alt: "Lola Lolita Land." },
  { image: GalleryImg30, alt: "Lola Lolita cantando sobre un escenario con un traje azul." },
  { image: GalleryImg31, alt: "Lola Lolita celebrando junto a Carlos Baute." },
  { image: GalleryImg32, alt: "Lola Lolita tomandose una foto con un grupo de personas" },
  {
    image: GalleryImg33,
